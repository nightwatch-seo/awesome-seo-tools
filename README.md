...
> A curated list of **400+ SEO tools** across **24 categories** — keyword research, rank tracking, backlinks, technical SEO, and the new AI search era (GEO / AEO). Updated for 2026.
...
**Legend:** 🆓 free (or generous free tier) · 🔓 open source · 🏢 enterprise

## Contents

- [All-in-One SEO Platforms](#all-in-one-seo-platforms)
- [Keyword Research](#keyword-research)
- [Content Ideas & Topic Research](#content-ideas--topic-research)
- [Rank Tracking](#rank-tracking)
- [Backlinks & Link Building](#backlinks--link-building)
- [Internal Linking](#internal-linking)
- [Content Optimization & AI Writing](#content-optimization--ai-writing)
- [AI Search Optimization (GEO / AEO)](#ai-search-optimization-geo--aeo)
- [AI Content Detection & Humanizers](#ai-content-detection--humanizers)
- [Technical SEO & Site Audits](#technical-seo--site-audits)
- [Web Crawlers & Log Analysis](#web-crawlers--log-analysis)
- [Indexing & Monitoring](#indexing--monitoring)
- [Page Speed & Core Web Vitals](#page-speed--core-web-vitals)
- [International & Multilingual SEO](#international--multilingual-seo)
- [Local SEO](#local-seo)
- [E-commerce & Marketplace SEO](#e-commerce--marketplace-seo)
- [YouTube & Video SEO](#youtube--video-seo)
- [Analytics](#analytics)
- [Reporting & Client Dashboards](#reporting--client-dashboards)
- [Structured Data, Validators & Checkers](#structured-data-validators--checkers)
- [APIs & Automation](#apis--automation)
- [CMS & WordPress Plugins](#cms--wordpress-plugins)
- [Social & Open Graph](#social--open-graph)
...
- [Search Atlas](https://searchatlas.com/) - AI-driven all-in-one platform blending real-time Google data with content automation.
- [SEO PowerSuite](https://www.link-assistant.com/) - Desktop toolkit (Rank Tracker, WebSite Auditor, SEO SpyGlass, LinkAssistant) with no per-keyword limits.
- [SpyFu](https://www.spyfu.com/) - Competitor intelligence — reveals rivals' most profitable keywords and ad history.
- [Sistrix](https://www.sistrix.com/) - Best known for its Visibility Index; strong European and international SERP data.
- [Seodity](https://seodity.com/) - Complete toolkit aimed at growing small-business organic traffic.
- [WebCEO](https://www.webceo.com/) - Agency-focused analysis, white-label reporting, and lead generation.
- [Zutrix](https://zutrix.com/) - AI-assisted rank tracking and monitoring suite.
- [CognitiveSEO](https://cognitiveseo.com/) - Backlink analysis and content auditing with unnatural-link detection.
- [Clicks.so](https://www.clicks.so/) - Affordable, beginner-friendly all-rounder.
- [Keyword Insights](https://www.keywordinsights.ai/) - AI keyword clustering, content briefs, and writing in one workflow.
- [Telescope](https://withtelescope.com/) - Affordable kit: keyword research, technical audits, rank tracking, and internal-linking ideas.
- [SEO Toolbox](https://seotoolbox.site) - Page-by-page analysis with AI insights and in-depth report generation.
- [Bishopi.io](https://www.bishopi.io/) - Enterprise-grade SEO and domain intelligence.
- [Spexia](https://getspexia.com) - Create and optimize informational content, specialized for e-commerce shops.
- [DiagnoSEO](https://diagnoseo.com/) - AI SEO and content-marketing tools, including a WordPress plugin.
- [DAXRM](https://www.daxrm.com/) - Digital-marketing CRM for agencies — SEO, PPC, client reporting, and collaboration.
- [SEO Utils](https://seoutils.app/) - Cross-platform desktop SEO app for macOS, Windows, and Linux.
- [Dragon Metrics](https://www.dragonmetrics.com/) - 🏢 Enterprise platform with strong Asian-market and international search coverage.
...
- [Diib](https://diib.com/) - Growth dashboard with automated SEO recommendations for small sites.
- [Raven Tools](https://raventools.com/) - Long-running SEO analysis and reporting suite for agencies.
- [BrightEdge](https://www.brightedge.com/) - 🏢 Enterprise platform for data-driven content optimization and competitive analysis.

## Keyword Research

Find, expand, and prioritize the terms your audience is actually searching for.

- [Google Keyword Planner](https://ads.google.com/home/tools/keyword-planner/) - 🆓 Keyword ideas and traffic estimates straight from Google Ads.
- [Google Trends](https://trends.google.com/trends/) - 🆓 Compare search interest over time, by region, and spot rising queries.
- [AnswerThePublic](https://answerthepublic.com/) - 🆓 Visualizes autocomplete questions and prepositions around a seed keyword.
...
- [Pro Rank Tracker](https://proranktracker.com/) - Highly accurate local and global tracking with white-label reports.
...
Audit your link profile, spy on competitors, prospect, and run outreach.
...
- [Hunter.io](https://hunter.io/) - Finds and verifies email addresses for outreach at scale.
- [BuzzStream](https://www.buzzstream.com/) - Outreach CRM for managing prospects, emails, and follow-ups.
- [Pitchbox](https://pitchbox.com/) - Automated outreach and link-building workflow for agencies and teams.
- [Respona](https://respona.com/) - End-to-end outreach and digital-PR link-building platform.
- [BacklinkGPT](https://www.backlinkgpt.com/) - AI-assisted prospecting and personalized outreach for faster link building.
- [Ranking Raccoon](https://rankingraccoon.com/) - Community-based, non-reciprocal link exchange for niche sites.
- [Authority Builders](https://authority.builders/) - Marketplace for vetted guest posts and niche edits.
- [WhitePress](https://www.whitepress.com/) - Content-marketing and sponsored-article marketplace across many markets.
- [Loganix](https://loganix.com/) - Done-for-you link building and other SEO fulfillment services.
- [BacklinkScan](https://backlinkscan.com/) - Straightforward backlink checker and profile analyzer.
- [YouLinker](https://youlinker.pro/) - Submits your product to many directories to seed early links.
- [SEO SpyGlass](https://www.link-assistant.com/seo-spyglass/) - Desktop backlink audit tool with penalty-risk checks.
- [Linkody](https://www.linkody.com/) - Automated backlink monitoring with disavow and reporting.
- [Kerboo](https://kerboo.com/) - Link auditing and risk analysis for cleanup and outreach.
- [Postaga](https://postaga.com/) - AI outreach platform for link building and cold email.
- [NinjaOutreach](https://ninjaoutreach.com/) - Influencer and blogger outreach database.
- [Snov.io](https://snov.io/) - Email finder and drip campaigns for outreach.
- [Semrush Backlink Analytics](https://www.semrush.com/analytics/backlinks/) - Competitor backlink gap and profile analysis.
- [Qwoted](https://www.qwoted.com/) - Connects sources with journalists for digital-PR links (HARO alternative).
- [Featured](https://featured.com/) - Answer expert queries to earn brand mentions and links.
...
- [MarketMuse](https://www.marketmuse.com/) - AI content planning and topic-authority modeling across your whole site.
- [NeuronWriter](https://neuronwriter.com/) - Affordable NLP-driven content editor with competitor term analysis.
- [Page Optimizer Pro](https://pageoptimizer.pro/) - On-page scoring built on correlation testing of ranking factors.
- [Dashword](https://www.dashword.com/) - Content briefs, optimization scoring, and content monitoring.
- [Outranking](https://www.outranking.io/) - SERP-driven AI writing with fact-based drafting and briefs.
- [Rankability](https://www.rankability.com/) - Content optimization with a cleaner, faster on-page score.
- [GrowthBar](https://www.growthbarseo.com/) - AI blog writing and optimization with keyword and outline tools.
- [Writesonic](https://writesonic.com/) - AI writing suite spanning articles, ads, and SEO-optimized long-form.
- [Penfriend AI](https://penfriend.ai/) - Generates full first-draft articles from keywords in your brand voice.
- [LSIGraph](https://lsigraph.com/) - Semantic keyword and content-brief generator.
- [Koala AI](https://koala.sh) - AI content platform with internal linking and entity-schema generation.
- [Hypertxt](https://hypertxt.ai) - Deeply-researched, SEO/GEO-optimized long-form content generation.
- [BlogBud AI](https://blogbud.ai) - Generate articles and publish straight to WordPress, Webflow, Ghost, or Shopify.
...
- [Writer](https://writer.com/) - Enterprise generative AI with brand and compliance guardrails.
- [WordLift](https://wordlift.io/) - AI SEO that adds structured data and builds a knowledge graph.
- [INK](https://inkforall.com/) - AI writing with on-page SEO optimization built in.
- [Article Forge](https://www.articleforge.com/) - Fully automated long-form article generation.
- [SEO.ai](https://seo.ai/) - AI writer focused on SEO briefs and optimized drafts.
- [Content at Scale](https://contentatscale.ai/) - Long-form AI content built to read naturally.
- [LongShot AI](https://www.longshot.ai/) - Fact-checked, research-backed AI content generation.
- [AltTextLab](https://www.alttextlab.com/) - Generates accessible, SEO-friendly alt text for images at scale.
...
- [Scrunch AI](https://www.scrunchai.com/) - Monitors and optimizes how AI models represent your brand.
- [AthenaHQ](https://www.athenahq.ai/) - GEO analytics for measuring and growing share of voice in AI answers.
- [Rankscale](https://rankscale.ai/) - AI-search visibility analytics across major answer engines.
- [ZipTie](https://ziptie.dev/) - Audits and tracks how visible your site is inside AI search results.
- [SearchAttention](https://searchattention.com) - Optimize content for AI Overviews, Perplexity, and SearchGPT.
...
Find and fix crawlability, indexation, and on-page issues.

- [Google Search Console](https://search.google.com/search-console/about) - 🆓 Essential: indexation, query performance, and issue reports straight from Google.
- [Bing Webmaster Tools](https://www.bing.com/webmasters/about) - 🆓 Bing's counterpart, with bonus keyword research and technical recommendations.
...
Measure load performance and the metrics Google actually ranks on.

- [PageSpeed Insights](https://pagespeed.web.dev/) - 🆓 Google's lab + field (CrUX) report on Core Web Vitals.
- [Google Lighthouse](https://developer.chrome.com/docs/lighthouse/overview/) - 🆓 🔓 Open-source audits for performance, accessibility, and SEO.
- [WebPageTest](https://www.webpagetest.org/) - 🆓 Deep, waterfall-level performance testing from real locations and devices.
- [CrUX Dashboard](https://developer.chrome.com/docs/crux/dashboard/) - 🆓 Chrome UX Report field data for your origin in Looker Studio.
...
- [RequestMetrics](https://requestmetrics.com/) - Lightweight real-user performance monitoring.
...
Rank in map packs and manage listings across locations.

- [Google Business Profile](https://www.google.com/business/) - 🆓 The free listing that powers Google Maps and local pack visibility.
- [BrightLocal](https://www.brightlocal.com/local-seo-tools/) - Complete platform to monitor, audit, and improve local SEO.
- [LocalFalcon](https://www.localfalcon.com/) - Geo-grid local rank tracker that visualizes rankings block by block.
- [Whitespark](https://whitespark.ca/) - Citation building and local rank tracking from local-SEO specialists.
- [Yext](https://www.yext.com/) - Enterprise listing and knowledge management across many directories at once.
- [Grid My Business](https://gridmybusiness.com/) - Fast geo-grid snapshots of your local map visibility.
- [Moz Local](https://moz.com/products/local) - Listing management and reputation monitoring across directories.
- [Uberall](https://uberall.com/) - Listing, review, and location management for multi-location brands.
- [Synup](https://www.synup.com/) - Listings, reviews, and local rank management dashboard.
- [Birdeye](https://birdeye.com/) - Reviews, listings, and local search visibility for multi-location brands.
- [Podium](https://www.podium.com/) - Reviews, messaging, and reputation for local businesses.
- [GatherUp](https://gatherup.com/) - Review generation and reputation management for local SEO.
- [SOCi](https://www.meetsoci.com/) - 🏢 Localized marketing and listings for enterprise multi-location brands.
- [Localo](https://localo.com/) - Google Business Profile optimization and local rank tracking.
- [PlePer](https://pleper.com/) - Local SEO tools and Google Business Profile audit utilities.

## E-commerce & Marketplace SEO

Rank on Amazon, Shopify, and other marketplaces and storefronts.

- [Helium 10](https://www.helium10.com/) - Amazon keyword, listing, and rank tools (Cerebro, Magnet).
- [Jungle Scout](https://www.junglescout.com/) - Amazon product and keyword research for sellers.
- [AMZScout](https://amzscout.net/) - Amazon product research, keywords, and sales estimates.
- [MerchantWords](https://www.merchantwords.com/) - Amazon shopper keyword data at scale.
- [ZonGuru](https://www.zonguru.com/) - Amazon research, listing optimization, and operations.
- [DataHawk](https://datahawk.co/) - Amazon and marketplace analytics and SEO monitoring.
- [Sellzone](https://www.sellzone.com/) - Semrush's Amazon toolkit for keywords and listing audits.
...
Understand traffic, behavior, and search performance — with privacy-friendly options.

- [Google Analytics 4](https://marketingplatform.google.com/about/analytics/) - 🆓 Google's event-based analytics standard for traffic and conversions.
- [Microsoft Clarity](https://clarity.microsoft.com/) - 🆓 Free heatmaps and session recordings for behavior analysis.
...
Turn SEO data into automated, shareable reports.

- [Google Looker Studio](https://lookerstudio.google.com/) - 🆓 Free, flexible dashboards connecting GSC, GA4, and hundreds of sources.
- [AgencyAnalytics](https://agencyanalytics.com/) - White-label client dashboards purpose-built for marketing agencies.
- [Databox](https://databox.com/) - KPI dashboards that pull metrics from many tools into one view.
- [DashThis](https://dashthis.com/) - Automated marketing reports with easy templates and integrations.
- [Supermetrics](https://supermetrics.com/) - Pipes marketing data into sheets, BI, and warehouses on a schedule.
- [Marketing Miner](https://www.marketingminer.com/) - Bulk data mining and reporting across SEO, PPC, and content.
- [Whatagraph](https://whatagraph.com/) - Automated multi-channel marketing reports.
- [Swydo](https://www.swydo.com/) - SEO and PPC reporting with goals and monitoring.
- [Klipfolio](https://www.klipfolio.com/) - Custom dashboards and data analytics.
- [Cyfe](https://www.cyfe.com/) - All-in-one business dashboard app.
- [Metrics Watch](https://metricswatch.com/) - Report delivery straight to email — no PDFs.
- [Octoboard](https://www.octoboard.com/) - Marketing analytics dashboards and client reporting.
- [TapClicks](https://www.tapclicks.com/) - 🏢 Enterprise marketing analytics and reporting platform.

## Structured Data, Validators & Checkers

Validate markup, links, robots, and sitemaps.

- [Rich Results Test](https://search.google.com/test/rich-results) - 🆓 Checks whether a page is eligible for Google rich results.
- [Schema Markup Validator](https://validator.schema.org/) - 🆓 Validates Schema.org structured data of any type.
- [Schema Markup Generator](https://technicalseo.com/tools/schema-markup-generator/) - 🆓 Generates JSON-LD structured data for common schema types.
- [robots.txt Report (Search Console)](https://support.google.com/webmasters/answer/6062598) - 🆓 Inspect and debug how Google reads your robots.txt.
- [XML Sitemap Validator](https://www.xml-sitemaps.com/validate-xml-sitemap.html) - 🆓 Validates XML sitemaps for structural errors.
- [Broken Link Checker](https://www.brokenlinkcheck.com/) - 🆓 Scans a site and reports dead internal and external links.
- [linkok.com](https://linkok.com) - 🆓 Modern, fast broken-link checker.
- [Wizardstool Broken Link Checker](https://wizardstool.com/) - 🆓 Simple broken-link scanner.
- [Siteliner](https://www.siteliner.com/) - 🆓 Finds duplicate content, broken links, and other quality issues.
- [W3C Markup Validator](https://validator.w3.org/) - 🆓 Validates HTML for standards compliance.
- [httpstatus.io](https://httpstatus.io/) - 🆓 Bulk HTTP status and redirect-chain checker.
- [Redirect Checker](https://www.redirect-checker.org/) - 🆓 Trace redirect paths and status codes for any URL.
- [Robots.txt Tester](https://technicalseo.com/tools/robots-txt/) - 🆓 Test robots.txt rules against specific user-agents.
- [JSON-LD Playground](https://json-ld.org/playground/) - 🆓 Validate and visualize JSON-LD structured data.
- [Nu HTML Checker](https://validator.w3.org/nu/) - 🆓 W3C's modern HTML conformance checker.
- [Yandex Structured Data Validator](https://webmaster.yandex.com/tools/microtest/) - 🆓 Validate microdata and structured data for Yandex.
...
- [ScraperAPI](https://www.scraperapi.com/) - Proxy and scraping API for large-scale data collection.
- [ScrapingBee](https://www.scrapingbee.com/) - Headless-browser scraping API.
- [Apify](https://apify.com/) - Web scraping and automation platform with ready-made actors.
- [Bright Data SERP API](https://brightdata.com/products/serp-api) - 🏢 Enterprise-grade SERP and web-data collection.

## CMS & WordPress Plugins

On-page SEO, schema, and sitemaps inside your CMS.

- [Yoast SEO](https://yoast.com/) - 🆓 The classic WordPress plugin for on-page and readability optimization.
- [Rank Math](https://rankmath.com/) - 🆓 Feature-rich WordPress SEO plugin with schema and content analysis.
- [All in One SEO](https://aioseo.com/) - 🆓 Long-running WordPress SEO plugin with schema, sitemaps, and redirects.
...
Control how your pages look when shared and generate share images.

- [OpenGraph.xyz](https://www.opengraph.xyz/) - 🆓 Preview and debug Open Graph / Twitter cards for any URL.
...
On-the-fly metrics and audits without leaving the page.

- [Google Lighthouse](https://chromewebstore.google.com/detail/lighthouse/blipmdconlkpinefehnmjammfjpmpbjk) - 🆓 🔓 One-click performance, accessibility, and SEO reports.
- [SEO Minion](https://chromewebstore.google.com/detail/seo-minion/giihipjfimkajhlcilipnjeohabimjhi) - 🆓 On-page analysis, broken-link check, SERP preview, and hreflang check.
- [SEOquake](https://www.seoquake.com/) - 🆓 Instant on-page audit, SERP overlay, and exportable metrics.
- [Detailed SEO Extension](https://detailed.com/extension/) - 🆓 Clean panel of on-page tags, headings, links, and schema.
- [MozBar](https://moz.com/products/pro/seo-toolbar) - 🆓 Domain/Page Authority and metrics for any page or SERP.
- [Ahrefs SEO Toolbar](https://chromewebstore.google.com/detail/ahrefs-seo-toolbar/hgmoccdbjhknikckedaaebbpdeebhiei) - 🆓 On-page report, broken-link checker, and redirect tracer.
- [Keyword Surfer](https://surferseo.com/keyword-surfer-extension/) - 🆓 Search volumes and keyword ideas right in Google results.
- [Redirect Path](https://chromewebstore.google.com/detail/redirect-path/aomidfkchockcldhbkggjokdkkebmdll) - 🆓 Flags redirects and HTTP status codes as you browse.
- [META SEO Inspector](https://chromewebstore.google.com/detail/meta-seo-inspector/ibkclpciafdglkjkcibmohobjkcfkaef) - 🆓 Inspects metadata and surfaces issues with fixes.
...
- [SEO META in 1 CLICK](https://chromewebstore.google.com/detail/seo-meta-in-1-click/bjogjfinolnhfhkbipphpdlldadpnmhc) - 🆓 Shows all on-page meta, headings, and links in one panel.
- [SEO Pro Extension](https://chromewebstore.google.com/detail/seo-pro-extension/kaefjbcjmklfmnmgfjjbngdopanmalck) - 🆓 On-page audit, meta preview, and headings overview.
- [Link Redirect Trace](https://chromewebstore.google.com/detail/link-redirect-trace/nnpljppamoaalgkieeojijnedmmpghfe) - 🆓 Full redirect path, rel attributes, and HTTP headers.
- [Web Developer](https://chromewebstore.google.com/detail/web-developer/bfbameneiokkgbdmiekhjnmfkcnldhhm) - 🆓 Toolbar of developer utilities useful for technical SEO.
...
Contributions welcome. Keep entries to a single, factual line (no marketing superlatives), place free/open-source tools toward the top of each category, and add the relevant 🆓 / 🔓 / 🏢 markers. Please check that the tool isn't already listed and that the link is live before submitting.
